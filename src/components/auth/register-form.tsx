  ...
  const handleOnSubmit: SubmitHandler<Inputs> = async (data) => {
    if (data.password != data.confirmPassword) {
      toast("Password doesn't match!", {
        description: "Field: Confirm Password",
      });
      return;
    }
          ...
          <form onSubmit={handleSubmit(handleOnSubmit)} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <Label htmlFor="email">{t("auth.register.name")}</Label>
                <Input
                  id="name"
                  type="text"
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  <Label htmlFor="password">{t("auth.register.pass")}</Label>
                </div>
                <Input
                  id="password"
                  type="password"
